...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="text-gray-600 mb-8">Here's your GPU Vector Search Service - Managed ANNS infrastructure for AI applications overview.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-8">
          ...
          <a href="/dashboard/indexes/[id]" className="block p-4 border rounded-lg hover:bg-blue-50 transition">
            ...
            <p className="text-sm text-gray-500">View and configure specific index</p>
          </a>
