...
const FROM = process.env.EMAIL_FROM || 'GPU Vector Search Service - Managed ANNS infrastructure for AI applications <noreply@example.com>';
const APP_NAME = 'GPU Vector Search Service - Managed ANNS infrastructure for AI applications';
