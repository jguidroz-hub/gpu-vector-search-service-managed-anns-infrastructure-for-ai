  ...
  try {
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="GPU Vector Search Service - Managed ANNS infrastructure for AI applications-export-${new Date().toISOString().split('T')[0]}.json"`,
      },
    });
  } catch (error: any) {
